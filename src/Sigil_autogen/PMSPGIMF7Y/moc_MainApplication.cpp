...
QT_MOC_LITERAL(1, 16, 20), // "applicationActivated"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 22) // "applicationDeactivated"

    },
    "MainApplication\0applicationActivated\0"
    "\0applicationDeactivated"
};
...
void MainApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->applicationActivated(); break;
        case 1: _t->applicationDeactivated(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainApplication::applicationActivated)) {
                *result = 0;
            }
        }
        {
            typedef void (MainApplication::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainApplication::applicationDeactivated)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject MainApplication::staticMetaObject = {
    { &QApplication::staticMetaObject, qt_meta_stringdata_MainApplication.data,
...
// SIGNAL 0
void MainApplication::applicationActivated()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void MainApplication::applicationDeactivated()
{
