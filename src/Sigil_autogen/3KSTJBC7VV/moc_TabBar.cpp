...
QT_MOC_LITERAL(1, 7, 13), // "TabBarClicked"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 19), // "TabBarDoubleClicked"
QT_MOC_LITERAL(4, 42, 21), // "CloseOtherTabsRequest"
QT_MOC_LITERAL(5, 64, 9), // "tab_index"
QT_MOC_LITERAL(6, 74, 18) // "EmitCloseOtherTabs"

    },
    "TabBar\0TabBarClicked\0\0TabBarDoubleClicked\0"
    "CloseOtherTabsRequest\0tab_index\0"
    "EmitCloseOtherTabs"
};
...
void TabBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->TabBarClicked(); break;
        case 1: _t->TabBarDoubleClicked(); break;
        case 2: _t->CloseOtherTabsRequest((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->EmitCloseOtherTabs(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TabBar::TabBarClicked)) {
                *result = 0;
            }
        }
        {
            typedef void (TabBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TabBar::TabBarDoubleClicked)) {
                *result = 1;
            }
        }
        {
            typedef void (TabBar::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TabBar::CloseOtherTabsRequest)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 0
void TabBar::TabBarClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void TabBar::TabBarDoubleClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 1, Q_NULLPTR);
}

// SIGNAL 2
void TabBar::CloseOtherTabsRequest(int _t1)
{
