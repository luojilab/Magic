...
QT_MOC_LITERAL(1, 12, 15), // "OpenFileRequest"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 17), // "SaveFilesToDelete"
QT_MOC_LITERAL(4, 47, 13), // "WriteSettings"
QT_MOC_LITERAL(5, 61, 11), // "DoubleClick"
QT_MOC_LITERAL(6, 73, 5) // "index"

    },
    "DeleteFiles\0OpenFileRequest\0\0"
    "SaveFilesToDelete\0WriteSettings\0"
    "DoubleClick\0index"
};
...
void DeleteFiles::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->SaveFilesToDelete(); break;
        ...
        {
            typedef void (DeleteFiles::*_t)(QString , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeleteFiles::OpenFileRequest)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DeleteFiles::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DeleteFiles.data,
      qt_meta_data_DeleteFiles,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void DeleteFiles::OpenFileRequest(QString _t1, int _t2)
{
