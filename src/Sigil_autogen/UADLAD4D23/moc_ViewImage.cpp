...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ViewImage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ViewImage_t qt_meta_stringdata_ViewImage = {
    {
QT_MOC_LITERAL(0, 0, 9), // "ViewImage"
QT_MOC_LITERAL(1, 10, 13), // "WriteSettings"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "ViewImage\0WriteSettings\0"
};
...
const QMetaObject ViewImage::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ViewImage.data,
...
void *ViewImage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ViewImage.stringdata0))
