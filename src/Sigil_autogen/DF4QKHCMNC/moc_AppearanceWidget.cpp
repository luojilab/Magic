...
QT_MOC_LITERAL(1, 17, 24), // "customColorButtonClicked"
QT_MOC_LITERAL(2, 42, 0), // ""
QT_MOC_LITERAL(3, 43, 21), // "resetAllButtonClicked"
QT_MOC_LITERAL(4, 65, 14), // "newSliderValue"
QT_MOC_LITERAL(5, 80, 5) // "value"

    },
    "AppearanceWidget\0customColorButtonClicked\0"
    "\0resetAllButtonClicked\0newSliderValue\0"
    "value"
};
...
void AppearanceWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->customColorButtonClicked(); break;
        case 1: _t->resetAllButtonClicked(); break;
        case 2: _t->newSliderValue((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject AppearanceWidget::staticMetaObject = {
    { &PreferencesWidget::staticMetaObject, qt_meta_stringdata_AppearanceWidget.data,
