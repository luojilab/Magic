...
const QString MIME_FILE_NAME = "mimetype";
const QString CONTAINER_FILE_NAME = "container.xml";

const QString CONTAINER_FILE_PATH = META_FOLEDER_NAME + "/" + CONTAINER_FILE_NAME;
const QString OPF_FILE_PATH = OEBPS_FOLEDER_NAME + "/" + OPF_FILE_NAME;
const QString TOC_FILE_PATH = OEBPS_FOLEDER_NAME + "/" + NCX_FILE_NAME;
